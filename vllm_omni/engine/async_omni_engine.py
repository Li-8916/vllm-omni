...
class AsyncOmniEngine:
    ...
    def _create_default_diffusion_stage_cfg(kwargs: dict[str, Any]) -> list:
        ...
        stage_engine_args = {
            ...
            "vae_tile_sample_min_height": kwargs.get("vae_tile_sample_min_height", None),
            "vae_tile_sample_min_width": kwargs.get("vae_tile_sample_min_width", None),
            "vae_tile_sample_stride_height": kwargs.get("vae_tile_sample_stride_height", None),
            "vae_tile_sample_stride_width": kwargs.get("vae_tile_sample_stride_width", None),
